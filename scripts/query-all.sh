...
for script in query-claude.sh query-codex.sh query-copilot.sh query-gemini-cli.sh query-antigravity-local.sh query-openrouter.sh query-synthetic.sh; do
